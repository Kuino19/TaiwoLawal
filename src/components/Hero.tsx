...
export default function Hero() {
    return (
        <section className="relative overflow-hidden min-h-screen flex items-center" style={{
            background: 'linear-gradient(160deg, #0d0520 0%, #1e0a4e 45%, #2e1065 100%)'
        }}>
            {/* Decorative orbs */}
            <div className="absolute inset-0 overflow-hidden z-0">
                <div className="absolute -top-32 -right-32 w-[600px] h-[600px] rounded-full opacity-[0.08]"
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        >
                            ...
                            <p className="text-lg text-white/55 font-sans font-light leading-relaxed max-w-xl mb-10">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4">
                                <Link href="/store"
                                    className="group inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full font-semibold text-white transition-all hover:opacity-90 hover:scale-[1.02]"
                                ...
                                <Link href="/quiz"
                                    className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full font-semibold transition-all hover:bg-white/10"
                                    style={{ color: 'rgba(255,255,255,0.85)', border: '1px solid rgba(255,255,255,0.2)', backdropFilter: 'blur(8px)' }}
                                >
                                    Join Competition
                                </Link>
                            </div>
                    ...
                    >
                        <div className="relative mx-auto max-w-sm">
                            ...
                            <div className="relative rounded-3xl overflow-hidden border border-white/10"
                                ...
                                <div className="h-80 relative overflow-hidden">
                                    ...
                                    <div className="absolute inset-x-0 bottom-0 h-20 flex items-end px-4 pb-3"
                                        style={{ background: 'linear-gradient(to top, rgba(13,5,32,0.9), transparent)' }}>
                                        <div>
                                ...
                                <div className="grid grid-cols-3 divide-x divide-white/8 px-2 py-4"
                                    ...
                                    {[
                                        ...
                                        <div key={stat.label} className="text-center px-2">
                                            ...
                                            <div className="text-white/45 text-xs font-sans mt-0.5">{stat.label}</div>
                                        </div>
                                    ))}
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <span className="text-white text-xs font-bold">Competitions Open!</span>
                            </motion.div>
                        </div>
                    </motion.div>
                </div>
